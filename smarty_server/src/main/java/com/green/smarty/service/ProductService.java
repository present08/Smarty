...
import com.green.smarty.mapper.ProductAttachMapper;
...
public class ProductService{
    ...
    @Autowired
    private ProductAttachMapper attachFileMapper;
    @Autowired
...
//    }
    ...
    public void deleteProduct(String product_id) {
        List<ProductAttachDTO> attachFiles = attachFileMapper.findByProductId(product_id);
        if (!attachFiles.isEmpty()) {
            fileUtil.deleteFiles(attachFiles.stream()
                    .map(attach -> ProductAttachDTO.builder()
...
//    }
    ...
    public ProductVO getProductById(String product_id) {
        ...
        ProductVO vo = productmapper.getProductById(product_id);
        if (vo == null) {
    ...
    public List<ProductAttachDTO> getAttachList(String product_id) {
