            ...
            <div className='parking-container' >
                <div className='submu'>
                    <nav>
                        ...
                        <p >&gt;</p>
                        <Link to="/centro_intro" style={{ textDecoration: 'none', color: 'black', padding: '10px' }}>센터소개</Link>
                        <p >&gt;</p>
                        <Link to="/parking_in" style={{ textDecoration: 'none', color: '#28537a', fontWeight: 'bold', padding: '10px', marginRight: '10px' }}>주차안내</Link>
                    </nav>
                </div>
